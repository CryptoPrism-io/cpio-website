...
export const ComparisonSection: React.FC<ComparisonSectionProps> = ({ className = '' }) => {
  ...
  return (
    <section ref={sectionRef} id="comparison" className={`relative lg:min-h-screen flex flex-col justify-center py-10 lg:py-20 px-4 sm:px-6 lg:px-12 xl:px-20 star-dust ${className}`}>
