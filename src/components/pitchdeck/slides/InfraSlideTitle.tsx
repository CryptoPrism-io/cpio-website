      ...
      <div className="flex flex-col items-center text-center gap-10">
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#c2410c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <h1 className="font-display text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tighter text-white">
            ...
            <br />
            <span className="text-[#c2410c]">Blueprint</span>
          </h1>
        ...
        <div className="w-24 h-px bg-gradient-to-r from-transparent via-[#c2410c] to-transparent opacity-50" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={s.label} className="flex flex-col items-center gap-1">
              <span className="font-mono text-[#c2410c] text-2xl md:text-3xl font-bold">{s.value}</span>
