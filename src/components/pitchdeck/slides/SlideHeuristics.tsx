...
export function SlideHeuristics() {
  return (
    <DeckSlide id="engine" number={5}>
      <div className="flex flex-col items-center gap-8">
        <h2 className="font-display text-3xl md:text-5xl font-bold text-white text-center">
          How corrections are <span className="text-[#0ecb81]">produced</span>
        </h2>

        <p className="text-gray-500 text-sm text-center max-w-lg">
          Not a chatbot. Not a dashboard. A real-time detection pipeline
          that identifies regime shifts before price confirms them.
        </p>
        ...
        <div className="flex items-center gap-8 mt-2">
          <div className="text-center">
            <span className="font-mono text-[#0ecb81] text-lg font-bold">&lt;200ms</span>
            <span className="text-gray-500 text-xs block">alert latency</span>
          </div>
          <div className="w-px h-8 bg-gray-700" />
          <div className="text-center">
            <span className="font-mono text-[#0ecb81] text-lg font-bold">200+</span>
            <span className="text-gray-500 text-xs block">features per candle</span>
          </div>
          <div className="w-px h-8 bg-gray-700" />
          <div className="text-center">
