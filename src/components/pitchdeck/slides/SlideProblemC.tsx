    ...
    <DeckSlide id="problem" number={2}>
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-5xl">
          {bleedScenarios.map((scenario) => (
            ...
            >
              ...
              <div className="font-mono text-[#ff4d4d] text-2xl font-bold">{scenario.stat}</div>
        ...
        <div className="glass-card rounded-xl p-5 w-full max-w-5xl border border-[rgba(255,77,77,0.2)]">
          <div className="font-mono text-[#ff4d4d] text-xs uppercase tracking-wider mb-3">In India, it's worse</div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={s.label} className="flex flex-col items-center text-center gap-1">
                <span className="font-mono text-[#ff4d4d] text-lg font-bold">{s.value}</span>
