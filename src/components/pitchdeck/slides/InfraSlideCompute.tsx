...
function IconContainer() {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ff9900" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <DeckSlide id="infra-compute" number={4}>
      <div className="flex flex-col items-center gap-6">
        <h2 className="font-display text-2xl md:text-4xl font-bold text-white text-center">
          Compute: <span className="text-[#ff9900]">Fargate + Lambda + Spot</span>
        </h2>
        ...
        <div className="glass-card rounded-lg px-4 py-2 flex items-center gap-3">
          ...
          <span className="font-mono text-[#ff9900] text-sm font-bold">$260/mo</span>
