...
function makeTokens(light: boolean): Tokens {
  if (light) {
    ...
    return {
      ...
      sh1:    'rgba(0,0,0,0.09)',
      sh2:    'rgba(0,0,0,0.06)',
      gr1:    'rgba(14,203,129,0.10)',
      gr2:    'rgba(14,203,129,0.07)',
      glow1:  ['rgba(14,203,129,0.08)', 'rgba(14,203,129,0.03)', 'rgba(14,203,129,0)'],
      glow2:  ['rgba(14,203,129,0.06)', 'rgba(14,203,129,0.02)', 'rgba(14,203,129,0)'],
  ...
  return {
    ...
    sh1:    'rgba(0,0,0,0.10)',
    sh2:    'rgba(0,0,0,0.08)',
    gr1:    'rgba(14,203,129,0.05)',
    gr2:    'rgba(14,203,129,0.04)',
    glow1:  ['rgba(14,203,129,0.06)', 'rgba(14,203,129,0.02)', 'rgba(14,203,129,0)'],
    glow2:  ['rgba(14,203,129,0.05)', 'rgba(14,203,129,0.015)', 'rgba(14,203,129,0)'],
